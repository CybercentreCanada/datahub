...
public class BrowsePathUtils {
  ...
  public static String getDefaultBrowsePath(Urn urn, EntityRegistry entityRegistry) throws URISyntaxException {
    switch (urn.getEntityType()) {
      ...
      case "license":
        LicenseKey licenseKey = (LicenseKey) EntityKeyUtils.convertUrnToEntityKey(urn, getKeySchema(urn.getEntityType(), entityRegistry));
        return "/" + licenseKey.getId().replace('.', '/').toLowerCase();
      default:
        return "";
    }
  }
